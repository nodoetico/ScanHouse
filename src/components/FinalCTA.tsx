...
export default function FinalCTA({ property, onRestart, onRequestVisit }: FinalCTAProps) {
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-black px-6" role="region" aria-label="Pantalla final">
      ...
      <div className="relative z-10 text-center max-w-xl mx-auto animate-fade-in-up">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <button
            ...
            className="btn-primary w-full sm:w-auto px-10 py-4 min-w-[240px] justify-center"
          >
            <span className="font-mono text-sm uppercase tracking-widest">SOLICITAR VISITA</span>
          </button>

          <a
            href={`https://wa.me/${property.assistantKnowledge.contact.whatsapp.replace(/\D/g, '')}?text=Hola, quiero coordinar una visita a ${property.name}`}
            target="_blank"
            rel="noopener noreferrer"
            className="btn-primary w-full sm:w-auto px-10 py-4 min-w-[240px] justify-center border-white/50 hover:bg-white/10"
          >
            ...
            <span className="font-mono text-sm uppercase tracking-widest">WHATSAPP</span>
          </a>
        </div>
        ...
        <div className="mt-16 pt-10 border-t border-white/10 w-full max-w-md mx-auto">
          <p className="font-mono text-xs uppercase tracking-widest text-white/30 text-center">
            {property.branding.name} — {property.branding.tagline}
          </p>
          <p className="font-mono text-xs uppercase tracking-widest text-white/20 text-center mt-2">
